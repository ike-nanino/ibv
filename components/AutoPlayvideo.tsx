...
const AutoPlayVideo: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-auto overflow-hidden">
      ...
      <div data-aos="fade-up" className="absolute inset-x-0 bottom-32 lg:bottom-96 flex justify-center mb-3 lg:mb-10">
        <h1 className='text-[#CCB37D]'>Unmatched Security, Global Trust</h1>
      </div>

      <div data-aos="fade-up" className="absolute inset-x-0 bottom-20 lg:bottom-72 flex justify-center">
